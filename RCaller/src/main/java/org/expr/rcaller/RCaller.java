...
import org.expr.rcaller.exception.RExecutableNotFoundException;
import org.expr.rcaller.exception.RscriptExecutableNotFoundException;
...
public class RCaller {
     ...
     * @throws org.expr.rcaller.exception.ExecutionException if a temporary file cannot
     ...
     *
     * @throws org.expr.rcaller.exception.ExecutionException if R cannot be run for some
     * reason
     */
    public void runOnly() throws org.expr.rcaller.exception.ExecutionException {
...
//                        + " Please set this variable to full path of R executable binary file.");
     ...
     *
     * @param var the R variable to return
     * @throws org.expr.rcaller.exception.ExecutionException if R could be started; if a
